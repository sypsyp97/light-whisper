...
- **register_via_reg_hotkey()** (8 connections) — `C:\Users\sun\Downloads\light-whisper\src-tauri\src\commands\hotkey.rs`
- **unregister_all_hotkeys()** (8 connections) — `C:\Users\sun\Downloads\light-whisper\src-tauri\src\commands\hotkey.rs`
- **build_hook_state()** (7 connections) — `C:\Users\sun\Downloads\light-whisper\src-tauri\src\commands\hotkey.rs`
- **dispatch_hotkey_press()** (7 connections) — `C:\Users\sun\Downloads\light-whisper\src-tauri\src\commands\hotkey.rs`
- **dispatch_hotkey_release()** (7 connections) — `C:\Users\sun\Downloads\light-whisper\src-tauri\src\commands\hotkey.rs`
- **handle_hotkey_start()** (7 connections) — `C:\Users\sun\Downloads\light-whisper\src-tauri\src\commands\hotkey.rs`
- **handle_hotkey_stop()** (7 connections) — `C:\Users\sun\Downloads\light-whisper\src-tauri\src\commands\hotkey.rs`
- **handle_standard_event()** (7 connections) — `C:\Users\sun\Downloads\light-whisper\src-tauri\src\commands\hotkey.rs`
- **normalize_shortcut()** (7 connections) — `C:\Users\sun\Downloads\light-whisper\src-tauri\src\commands\hotkey.rs`
