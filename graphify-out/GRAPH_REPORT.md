...
## Corpus Check
- 112 files · ~94,842 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1222 nodes · 2052 edges · 100 communities detected
...
- [[_COMMUNITY_Tauri.test|Tauri.test]]
- [[_COMMUNITY_Kbd|Kbd]]
...
6. `endpoint_for_preview()` - 17 edges
7. `openai_endpoint()` - 16 edges
8. `register_custom_hotkey()` - 15 edges
9. `login()` - 15 edges
10. `send_llm_request()` - 15 edges
...
### Community 0 - "Hotkey"
Cohesion: 0.07
Nodes (77): Real-time translation, all_modifiers_down(), build_hook_state(), build_hook_state_with_backend(), classify_backend(), dispatch_channel(), dispatch_hotkey_press(), dispatch_hotkey_release() (+69 more)

### Community 1 - "LLM Provider"
Cohesion: 0.05
Nodes (67): apply_reasoning_controls(), assistant_endpoint_for_config(), assistant_endpoint_uses_separate_model_for_builtin_provider(), assistant_endpoint_uses_separate_model_for_custom_provider(), build_auth_headers(), builds_cerebras_image_support_probe_url(), cerebras_glm_reports_reasoning_support(), cerebras_public_model_probe_url() (+59 more)

### Community 2 - "LLM Client"
Cohesion: 0.07
Nodes (62): adapt_body_for_backend(), anthropic_output_tokens(), api_error_message_falls_back_to_openai_compat_parser(), build_llm_body(), build_stream_event_payload(), cerebras_json_output_disables_stream_to_preserve_response_format(), cerebras_without_json_output_keeps_stream(), chat_body_keeps_provider_default_reasoning() (+54 more)

### Community 3 - "Server Common"
Cohesion: 0.04
...
### Community 5 - "Tauri"
Cohesion: 0.07
Nodes (51): addCustomProvider(), addHotWord(), copyToClipboard(), getAiPolishApiKey(), getAlibabaAsrConfig(), getAssistantApiKey(), getLlmReasoningSupport(), getModelsDir() (+43 more)

### Community 6 - "Funasr Service"
Cohesion: 0.07
...
### Community 7 - "Web Search Service"
Cohesion: 0.05
...
Cohesion: 0.13
Nodes (26): compute_waveform_bars(), load_best_input_config(), mix_to_mono_capped_f32(), mix_to_mono_capped_f32_at_cap_appends_zero(), mix_to_mono_capped_f32_partial_fit_truncates(), mix_to_mono_capped_f32_stereo_downmix(), mix_to_mono_capped_f32_stereo_partial_fit(), mix_to_mono_capped_f32_under_cap_appends_all() (+18 more)
...
Cohesion: 0.11
Nodes (9): add_custom_provider(), extract_corrections_via_llm(), normalize_custom_provider_fields(), parse_correction_pairs(), parse_invalid_indices(), run_correction_validation(), submit_user_correction(), update_validation_timestamp() (+1 more)
...
### Community 18 - "Alibaba ASR Service"
Cohesion: 0.15
...
### Community 19 - "Foreground Context"
Cohesion: 0.2
...
### Community 21 - "Test Download Models Regression"
Cohesion: 0.15
Nodes (4): FakeCompleteResponse, FakeRangeNotSatisfiableResponse, FakeStreamingResponse, ModelDownloadAtomicityTests

### Community 22 - "Error"
Cohesion: 0.16
Nodes (3): app_error_serialized_code_and_category_match_methods(), AppError, StructuredAppError

### Community 23 - "Ai Polish"
Cohesion: 0.18
Nodes (9): AiModelInfo, AiModelListPayload, anthropic_models(), codex_oauth_catalog_includes_gpt_5_5(), codex_oauth_models(), list_ai_models(), set_ai_polish_config(), set_assistant_api_key() (+1 more)
...
### Community 29 - "Updater"
Cohesion: 0.31
Nodes (10): AppUpdateInfo, check_app_update(), fetch_latest_release(), GitHubRelease, is_version_newer(), normalize_version(), open_app_release_page(), open_external_url() (+2 more)

### Community 30 - "HF Cache Utils"
Cohesion: 0.29
...
### Community 33 - "Hotkey Normalization"
Cohesion: 0.36
...
### Community 34 - "Openai Fast Mode OAuth Tests"
Cohesion: 0.39
...
### Community 35 - "Assistant Commands"
Cohesion: 0.36
...
### Community 39 - "Status Indicator UI"
Cohesion: 0.4
Nodes (0): 

### Community 40 - "Model Status Hook"
Cohesion: 0.4
Nodes (0): 

### Community 41 - "Theme Hook"
Cohesion: 0.5
Nodes (2): getSystemPrefersDark(), resolveIsDark()

### Community 42 - "Resample"
Cohesion: 0.6
Nodes (3): f32_to_i16(), invalid_sample_rate_is_not_reported_as_successful_16k_audio(), resample_to_16k()

### Community 43 - "Frontend Entry"
Cohesion: 0.5
Nodes (0): 

### Community 44 - "Hotkey Storage Hook"
Cohesion: 0.5
Nodes (0): 

### Community 45 - "Use Smooth Text"
Cohesion: 0.67
Nodes (2): segmentGraphemes(), useSmoothText()

### Community 46 - "Codex OAuth Commands"
Cohesion: 0.5
Nodes (0): 

### Community 47 - "Ai Polish Transport Retry Tests"
Cohesion: 0.83
...
### Community 85 - "Recording Button UI"
Cohesion: 1.0
Nodes (0): 

### Community 86 - "Transcription History UI"
Cohesion: 1.0
Nodes (0): 

### Community 87 - "Transcription Result UI"
Cohesion: 1.0
Nodes (0): 

### Community 88 - "English I18n"
Cohesion: 1.0
Nodes (0): 

### Community 89 - "I18n Index"
Cohesion: 1.0
Nodes (0): 

### Community 90 - "Chinese I18n"
Cohesion: 1.0
Nodes (0): 

### Community 91 - "App Constants"
Cohesion: 1.0
Nodes (0): 

### Community 92 - "Fast Mode.test"
Cohesion: 1.0
Nodes (0): 

### Community 93 - "Main Page"
Cohesion: 1.0
Nodes (0): 
...
### Community 95 - "Types Index"
Cohesion: 1.0
Nodes (0): 

### Community 96 - "Commands Module"
Cohesion: 1.0
Nodes (0): 

### Community 97 - "Services Module"
Cohesion: 1.0
Nodes (0): 

### Community 98 - "State Module"
Cohesion: 1.0
Nodes (0): 

### Community 99 - "Utils Module"
Cohesion: 1.0
Nodes (0): 

## Knowledge Gaps
- **104 isolated node(s):** `删除目录；在 Windows 文件句柄尚未释放时做有限重试。`, `删除可安全裁剪的 CUDA DLL，返回节省的 MB 数`, `删除运行时不需要的链接/调试产物，返回节省的 MB 数。`, `校验 torch_cuda.dll 的直接 CUDA 依赖仍然存在。`, `使用 Python 标准库压缩为 tar.xz，返回压缩包大小 MB。` (+99 more)
...
- **Thin community `Tauri.fast Mode.test`** (1 nodes): `tauri.fastMode.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Tauri.test`** (1 nodes): `tauri.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Light-Whisper overview` connect `Web Search Service` to `Hotkey`, `Profile Service`, `Window`?**
